...
urlpatterns = [
    ...
    path("term_time/", views.term_time, name='term_time'),
    path("term_time/<int:id>/update", views.term_time_update, name='term_time_update'),
    path("term_time/term_create", views.term_create, name='term_create'),
